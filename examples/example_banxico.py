...
serie = banxico_api.get_series_data(
    serie_id, start_date="2023-03-01", percentage_change="PorcAnual"
)
...
print(
    serie.loc[
        pd.date_range(start="2024-01-01", end="2024-12-01", freq="QS-MAR").date,
        "SR17622",
    ]
)
print("\n")
...
serie = banxico_api.get_series_data(
    serie_id, last_data=True, percentage_change="PorcAnual"
)
print(serie)
print("\n")
